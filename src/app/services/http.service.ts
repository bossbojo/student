...
export class HttpService {
    ...
    //private address: string = 'http://localhost:65030/api';
    private address: string = 'http://office.payan.com/api';
    //private address: string = environment.production ?  'http://localhost:65030/api':'http://office.payan.com/api';
}
